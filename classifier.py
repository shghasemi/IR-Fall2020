...
class NaiveBayesClassifier:
    ...
    def fit(self, X_train, y_train):
        ...
        for column in X_train.T:
            ...
            total_num_terms_c1 += num_term_c1
        self.prob_terms_c0 = np.array([log2(f / (1 * num_distinct_terms + total_num_terms_c0))
                                       for f in num_docs_per_term_c0])
        self.prob_terms_c1 = np.array([log2(f / (1 * num_distinct_terms + total_num_terms_c1))
